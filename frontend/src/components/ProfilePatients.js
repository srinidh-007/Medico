...
const ProfilePatients = () => {
  ...
  const insertUserInfo = async () => {
    ...
    document.querySelector('#profession_input').value = posts.profession;
    document.querySelector('#blood_group_input').value = posts.blood_group;
  ...
  const CreatePost = async (e) => {
    ...
    const doc = {
      ...
      blood_group: document.querySelector('#blood_group_input').value,
      profession: document.querySelector('#profession_input').value,
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <div class="col-md-12">
                    <label class="labels" for="profession">Profession:</label> <br />
                    <input id="profession_input" type="text" class="form-control" list="profession" name="profession" />
                    </div>
                    <div class="col-md-12"><label class="labels">Blood Group 🩸</label>
                    <input id="blood_group_input" list="blood_group" name="blood_group" type="text" class="form-control"  />
