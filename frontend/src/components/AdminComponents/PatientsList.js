...
const PatientsList = () => {
  ...
  const updateCount = async () => {
    ...
    let footer_container = document.querySelector('#footer_patients_count');
    container.innerHTML = posts.length;
  ...
  const renderPosts = async (term) => {
    ...
    let uri = 'http://localhost:8000/patients?_sort=f_name';
    if (term) {
      uri += `&q=${term}`
    }
    ...
    posts.forEach(post => {
      ...
      <tr>
          <td>
              ...
              <a href="/patientsList/details?id=${post._id}" class="text-heading text-heading-name font-semibold" >
          ...
          <td class="text-end">
              <a href="/patientsList/details?id=${post._id}" class="btn btn-sm btn-neutral">View</a>
          </td>
      </tr>
                      ...
                      <div className="mb-npx">
                          <div className="row align-items-center">
                              ...
                              <div className="create-button col-sm-6 col-12 text-sm-end">
                                  <div className="mx-n1">
                                      <a href="#" className="btn create-button-patient d-inline-flex btn-sm btn-primary mx-1">
                                          <span className=" pe-2">
                          ...
                          <ul className="nav nav-tabs mt-4 overflow-x border-0">
                              <li className="nav-item ">
                                  <a href="/doctorsList" className="nav-link font-regular">Doctors</a>
                              </li>
                              <li className="nav-item">
                                  <a href="/patientsList" className="nav-link active">Patients</a>
                              </li>
                          </ul>
                      </div>
                  </div>
                  ...
                  <div className="container-fluid">
                      ...
                      <div className="card shadow border-0 mb-7">
                          <div className="card-header">
                              <h5 className="search-head mb-0">Patients Registered</h5>
                          ...
                          <div className="card-footer border-0 py-5">
                              <p className="text-muted text-sm">Showing items out of <span id="footer_patients_count"></span> results found</p>
                          </div>
                      </div>
                  </div>
              </main>
